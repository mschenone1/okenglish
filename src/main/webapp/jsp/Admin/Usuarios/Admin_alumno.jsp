...
<html>
    ...
    <body style="background-color: #C1E8FF">
        <br><center>
            <a href="Admin_alumno.jsp" class="btn btn-primary">Alumno</a>
            <a href="Admin_docente.jsp" class="btn btn-secondary">Docente</a>
            <a href="Admin_admin.jsp" class="btn btn-secondary">Administrador</a>
        </center><br><br>
        <table class="table table-hover">
            <tr class="bg-gradient-blue" >
                <th>Codigo de alumno<th>Nombre y apellidos<th>Correo<th>Contraseña<th>Clase
            </table>
