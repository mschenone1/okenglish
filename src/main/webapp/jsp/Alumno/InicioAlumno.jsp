        ...
        <div class="contenedor">
            ...
            <div id="contenidopestanas">
                <div id="cpestana1" class="embed-container">
                    <iframe src="jsp/Alumno/Alumno_curso.jsp" frameborder="0" allowfullscreen></iframe> 
                </div>
                <div id="cpestana2" class="embed-container">
                    <iframe src="jsp/Alumno/Alumno_leccion.jsp" frameborder="0" allowfullscreen></iframe> 
                </div>
                <div id="cpestana3" class="embed-container">
                    <iframe src="jsp/Alumno/Alumno_libro.jsp" frameborder="0" allowfullscreen></iframe> 
                </div>
                <div id="cpestana4" class="embed-container">
                    <iframe src="jsp/Alumno/Alumno_horario.jsp" frameborder="0" allowfullscreen></iframe> 
                </div>
            </div>
        </div>
    </body>
